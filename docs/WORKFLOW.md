...
> 最后更新：2026-06-03（含模板图册手册/清单/批量下载）  
...
详见 [模板列表 §7](TEMPLATE-LIST-UPDATES.md)。
...
| 已发布只读 / 下架 / 版本 | [TEMPLATE-LIST-UPDATES.md](TEMPLATE-LIST-UPDATES.md) §7 |
